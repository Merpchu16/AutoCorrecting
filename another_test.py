...
class Autocorrector:
    ...
    def load_dictionary(self, dictionary_file):
        ...
        exec(dictionary_data, self.dictionary)
    
    def find_most_similar_word(self, word):
        closest_words = difflib.get_close_matches(word, self.dictionary.keys(), n=5, cutoff=0.8)
        return closest_words
...
def main():
    ...
    print("Is this what you meant?: ", ctd_sentence)
    print("Total edit distance: ", total_edit_distance)
