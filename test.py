...
# Step 2: Convert data to JSON string
json_data = json.dumps(data)

# Step 3: Write JSON string to a file
file_path = "data.json"  # Specify the file path
with open(file_path, "w") as file:
    file.write(json_data)

# Step 4: File created and data is written
